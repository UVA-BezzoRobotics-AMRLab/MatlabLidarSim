...
function RosbotMake(p,heading_ang,lightbox,scale)
...
Q.Rosbot1_P1 = patch(yB(1,:),yB(2,:),lightbox,'FaceColor',lightbox,'EdgeColor','k','LineWidth',.6);
lT = R*params.leftTires + Rosbot_pos;
Q.Rosbot1_P2 = patch(lT(1,:),lT(2,:),'k','FaceColor','k','EdgeColor','k','LineWidth',.8);
rT = R*params.rightTires + Rosbot_pos;
Q.Rosbot1_P3 = patch(rT(1,:),rT(2,:),'k','FaceColor','k','EdgeColor','k','LineWidth',.8);
Gps = R*params.UGV_GPS + Rosbot_pos;
Q.Rosbot1_P4 = patch(Gps(1,:),Gps(2,:),'k','FaceColor','k','EdgeColor','k','LineWidth',.2);
